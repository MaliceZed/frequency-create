...
public class FrequencyModTabs {
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> FREQUENCY_CREATE_TAB = REGISTRY.register("frequency_create_tab",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.frequency.frequency_create_tab")).icon(() -> new ItemStack(FrequencyModItems.SYMBOL_C.get())).displayItems((parameters, tabData) -> {
